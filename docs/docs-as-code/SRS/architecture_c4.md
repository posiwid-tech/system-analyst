...
*Внешняя система бронированя* - внешняя информационная система, которая может являться мастер-системой бронирования уже существующей на отдельных площадках, на которых сдаются в аренду пространства.

Система бронирования запрашивает во внешней системе бронирования данные о свободных слотах и передает в нее данные о бронировании.
